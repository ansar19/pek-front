            ...
            <div class="table mt-2">
              <table class="meta-table table table-stripped table-bordered">
                ...
                <tr v-for="releaseSource, index in releaseSources" :key="index">
                  ...
                  <td>
                    {{ releaseSource.waterLimitPolName }}
                  </td>
                  <td>
                    {{ releaseSource.waterSourceLimit }}
                  </td>
                </tr>
              </table>
            </div>
