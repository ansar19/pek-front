  ...
  <div class="meta-table">
    ...
    >
      <div slot="table-actions">
        <router-link to="/new-operational-monitoring">
  ...
  data(){
    return{
      columns: [
        ...
        {
          label: 'Установленный норматив (миллиграмм на дециметр кубический; тонн в год)',
          field: 'state',
          tdClass: 'text-right',
          width: '15%',
        },
      ...
      rows: [
        {
          id:1,
          name: 'выпуск ВП 10 (х/б сточные воды до очистных сооружений)',
          code: 'Температура',
          state: '10.0',
          index: 'AC030',
          limit: '120',
